...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo APP_URL;?>visual/img/favicon.ico?v=1" />

	<title><?php echo $title;?></title>
    
    <link href="<?php echo APP_URL;?>visual/css/stylesheets/admin.css?v=1" rel="stylesheet">
    ...
    <!--
    <script type="text/javascript" src="<?php echo APP_URL; ?>libjs/jscolor/jscolor.js"></script>
