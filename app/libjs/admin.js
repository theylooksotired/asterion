...
function ajaxAdmin() {
	...
	$('.nestedFormFieldsEmpty :input').attr('disabled', true);
	//Add
	$('.nestedFormFieldsAdd').click(function(event){
		event.stopImmediatePropagation();
		var self = $(this);
		var container = self.parents('.nestedFormFields');
		var newForm = container.find('.nestedFormFieldsEmpty');
		var formsContainer = container.find('.nestedFormFieldsIns');
		var newFormClone = newForm.clone();
		newFormClone.removeClass('nestedFormFieldsEmpty');
		newFormClone.addClass('nestedFormFieldsObject');
	...
	//Delete
	$('.nestedFormFieldsDelete').click(function(event){
		event.stopImmediatePropagation();
		var self = $(this);
		var container = $(this).parents('.nestedFormFieldsObject');
	...
	$('.nestedFormFieldsSortable').each(function(index, ele){
		$(ele).sortable({
			handle:'.nestedFormFieldsOrder',
